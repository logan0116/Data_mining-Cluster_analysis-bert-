...
if __name__ == '__main__':
    ...
    csv_read = csv.reader(open('词向量预处理数据_1/yjm_20201023_2_span.csv', 'r', encoding='UTF-8'))
    txt_list = []
    ...
    for i in range(len(cluster_list)):
        csv_write = csv.writer(open('cluster_20201023/cluster_' + str(i) + '.csv', 'w', encoding='UTF-8', newline=''))
